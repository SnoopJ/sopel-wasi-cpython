...
build_time_vars = {
    ...
    'BINLIBDEST': '/usr/local/lib/python3.14',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '',
    'CONFIGURE_LDFLAGS_NODIST': '-z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--host=wasm32-wasip1' '--build=x86_64-pc-linux-gnu' '--with-build-python=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-wasip1' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/opt/wasi-sdk/share/wasi-sysroot/lib/pkgconfig:/opt/wasi-sdk/share/wasi-sysroot/share/pkgconfig' 'CC=/opt/wasi-sdk/bin/clang' 'CPP=/opt/wasi-sdk/bin/clang-cpp'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.14 LCOV report [commit $(shell git --git-dir ../../.git rev-parse --short HEAD)]"',
    'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'CXX': '/opt/wasi-sdk/bin/clang++',
    'DESTDIRS': '/usr/local /usr/local/lib /usr/local/lib/python3.14 /usr/local/lib/python3.14/lib-dynload',
    'DESTLIB': '/usr/local/lib/python3.14',
    'DESTPATH': '',
    ...
    'EMSCRIPTEN_DIR': '../../Platforms/emscripten',
    'ENABLE_IPV6': 0,
    'ENSUREPIP': 'no',
    'EXE': '.wasm',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/bin/python3.14.wasm',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'FILEMODE': 644,
    'FREEZE_MODULE': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python ../../Programs/_freeze_module.py',
    ...
    'HAVE_CTERMID': 0,
    'HAVE_CTERMID_R': 0,
    'HAVE_CURSES_ESCDELAY': 0,
    'HAVE_CURSES_FILTER': 0,
    'HAVE_CURSES_GETMOUSE': 0,
    'HAVE_CURSES_H': 0,
    ...
    'HAVE_CURSES_SET_ESCDELAY': 0,
    'HAVE_CURSES_SET_TABSIZE': 0,
    'HAVE_CURSES_SYNCOK': 0,
    'HAVE_CURSES_TABSIZE': 0,
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --argv0 cross-build/wasm32-wasip1/python.wasm --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14',
    'HOST_GNU_TYPE': 'wasm32-unknown-wasip1',
    'INCLDIRSTOMAKE': '/usr/local/include /usr/local/include /usr/local/include/python3.14 /usr/local/include/python3.14',
    'INCLUDEDIR': '/usr/local/include',
    'INCLUDEPY': '/usr/local/include/python3.14',
    ...
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.14',
    ...
    'LIBPL': '/usr/local/lib/python3.14/config-3.14-wasm32-wasi',
    'LIBPYTHON': '',
    ...
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a  Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lm Modules/expat/libexpat.a                          -lm',
    'MACHDEP': 'wasi',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/usr/local/lib/python3.14',
    ...
    'MODULE__BLAKE2_DEPS': '../../Modules/hashlib.h \\ Modules/_hacl/libHacl_Hash_BLAKE2.a',
    'MODULE__BLAKE2_LDEPS': 'Modules/_hacl/libHacl_Hash_BLAKE2.a',
    ...
    'MODULE__HMAC_DEPS': '../../Modules/hashlib.h \\ Modules/_hacl/libHacl_HMAC.a',
    'MODULE__HMAC_LDEPS': 'Modules/_hacl/libHacl_HMAC.a',
    ...
    'MODULE__MD5_DEPS': '../../Modules/hashlib.h \\ Modules/_hacl/libHacl_Hash_MD5.a',
    'MODULE__MD5_LDEPS': 'Modules/_hacl/libHacl_Hash_MD5.a',
    ...
    'MODULE__REMOTE_DEBUGGING_STATE': 'n/a',
    'MODULE__SCPROXY_STATE': 'n/a',
    'MODULE__SHA1_CFLAGS': '-I../../Modules/_hacl -I../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'MODULE__SHA1_DEPS': '../../Modules/hashlib.h \\ Modules/_hacl/libHacl_Hash_SHA1.a',
    'MODULE__SHA1_LDEPS': 'Modules/_hacl/libHacl_Hash_SHA1.a',
    ...
    'MODULE__SHA2_LDEPS': 'Modules/_hacl/libHacl_Hash_SHA2.a',
    'MODULE__SHA2_LDFLAGS': 'Modules/_hacl/libHacl_Hash_SHA2.a',
    'MODULE__SHA2_STATE': 'yes',
    'MODULE__SHA3_CFLAGS': '-I../../Modules/_hacl -I../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include',
    'MODULE__SHA3_DEPS': '../../Modules/hashlib.h \\ Modules/_hacl/libHacl_Hash_SHA3.a',
    'MODULE__SHA3_LDEPS': 'Modules/_hacl/libHacl_Hash_SHA3.a',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --argv0 cross-build/wasm32-wasip1/python.wasm --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14' _PYTHON_PROJECT_BASE=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/`cat pybuilddir.txt`) /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    ...
    'PY_CORE_LDFLAGS': '-z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '',
    'PY_LDFLAGS_NODIST': '-z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'PY_LDFLAGS_NOLTO': '',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --argv0 cross-build/wasm32-wasip1/python.wasm --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14' _PYTHON_PROJECT_BASE=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/`cat pybuilddir.txt`) /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='/home/runner/downloader/bin/wasmtime run --wasm max-wasm-stack=16777216 --argv0 cross-build/wasm32-wasip1/python.wasm --dir /home/runner/work/cpython-wasi-build/cpython-wasi-build::/ --env PYTHONPATH=/cross-build/wasm32-wasip1/build/lib.wasi-wasm32-3.14' _PYTHON_PROJECT_BASE=/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/`cat pybuilddir.txt`) /home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/x86_64-pc-linux-gnu/python -m test",
    ...
    'WEBEX2_DIR': '../../Platforms/emscripten/web_example_pyrepl_jspi/',
    'WEBEX_DIR': '../../Platforms/emscripten/web_example/',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1',
    'abs_srcdir': '/home/runner/work/cpython-wasi-build/cpython-wasi-build/cross-build/wasm32-wasip1/../..',
