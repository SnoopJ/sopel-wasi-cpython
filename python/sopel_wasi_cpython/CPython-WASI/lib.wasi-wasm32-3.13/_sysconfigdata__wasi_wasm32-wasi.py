...
build_time_vars = {
    ...
    'ALT_SOABI': 0,
    'ANDROID_API_LEVEL': 0,
    'AR': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/wasm-ld',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.wasm',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/clang --sysroot=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot',
    'CCSHARED': '',
    ...
    'CONFIG_ARGS': "'--host=wasm32-wasi' '--build=x86_64-pc-linux-gnu' '--with-build-python=/home/jgerity/repos/cpython/cross-build/build/python' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-wasi' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot/lib/pkgconfig:/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot/share/pkgconfig' 'CC=/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/clang --sysroot=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot' 'CPP=/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/clang-cpp --sysroot=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot' 'HOSTRUNNER=/home/jgerity/repos/cpython/wasmtime-v17.0.0-x86_64-linux/wasmtime run --wasm max-wasm-stack=8388608 --wasm threads=y --wasi threads=y --dir /home/jgerity/repos/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/jgerity/repos/cpython/cross-build/wasm32-wasi/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/jgerity/repos/cpython/cross-build/wasm32-wasi/lcov-report',
    ...
    'CXX': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/clang++ --sysroot=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot',
    'DEEPFREEZE_C': 'Python/deepfreeze/deepfreeze.c',
    'DEEPFREEZE_DEPS': '../../Tools/build/deepfreeze.py Include/internal/pycore_global_strings.h ../../Programs/_freeze_module.py \\',
    ...
    'FREEZE_MODULE': '/home/jgerity/repos/cpython/cross-build/build/python ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/home/jgerity/repos/cpython/cross-build/build/python ../../Programs/_freeze_module.py',
    ...
    'HAVE_ZLIB_H': 0,
    'HAVE__GETPTY': 0,
    'HOSTRUNNER': '/home/jgerity/repos/cpython/wasmtime-v17.0.0-x86_64-linux/wasmtime run --wasm max-wasm-stack=8388608 --wasm threads=y --wasi threads=y --dir /home/jgerity/repos/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13',
    ...
    'IO_OBJS': '\\',
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/wasm-ld',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/wasm-ld',
    'LDVERSION': '3.13',
    'LIBC': '',
    ...
    'LIBS': '-lwasi-emulated-signal -lwasi-emulated-getpid -lwasi-emulated-process-clocks',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/home/jgerity/repos/cpython/wasi-sdk-20.0/bin/clang --sysroot=/home/jgerity/repos/cpython/wasi-sdk-20.0/share/wasi-sysroot',
    'LINKFORSHARED': '',
    ...
    'MODULE__XXINTERPQUEUES_STATE': 'n/a',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='/home/jgerity/repos/cpython/wasmtime-v17.0.0-x86_64-linux/wasmtime run --wasm max-wasm-stack=8388608 --wasm threads=y --wasi threads=y --dir /home/jgerity/repos/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13' _PYTHON_PROJECT_BASE=/home/jgerity/repos/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/jgerity/repos/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi /home/jgerity/repos/cpython/cross-build/build/python",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/home/jgerity/repos/cpython/cross-build/build/python',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    ...
    'PY_CORE_LDFLAGS': '-z stack-size=524288 -Wl,--stack-first -Wl,--initial-memory=10485760',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '',
    'PY_LDFLAGS_NODIST': '-z stack-size=524288 -Wl,--stack-first -Wl,--initial-memory=10485760',
    'PY_LDFLAGS_NOLTO': '',
    ...
    'SETPGRP_HAVE_ARG': 0,
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-lwasi-emulated-signal -lwasi-emulated-getpid -lwasi-emulated-process-clocks',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='/home/jgerity/repos/cpython/wasmtime-v17.0.0-x86_64-linux/wasmtime run --wasm max-wasm-stack=8388608 --wasm threads=y --wasi threads=y --dir /home/jgerity/repos/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13' _PYTHON_PROJECT_BASE=/home/jgerity/repos/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/jgerity/repos/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi /home/jgerity/repos/cpython/cross-build/build/python",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='/home/jgerity/repos/cpython/wasmtime-v17.0.0-x86_64-linux/wasmtime run --wasm max-wasm-stack=8388608 --wasm threads=y --wasi threads=y --dir /home/jgerity/repos/cpython::/ --env PYTHONPATH=/cross-build/wasm32-wasi/build/lib.wasi-wasm32-3.13' _PYTHON_PROJECT_BASE=/home/jgerity/repos/cpython/cross-build/wasm32-wasi _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /home/jgerity/repos/cpython/cross-build/wasm32-wasi/`cat pybuilddir.txt`:)../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi /home/jgerity/repos/cpython/cross-build/build/python -m test",
    ...
    'abs_builddir': '/home/jgerity/repos/cpython/cross-build/wasm32-wasi',
    'abs_srcdir': '/home/jgerity/repos/cpython/cross-build/wasm32-wasi/../..',
